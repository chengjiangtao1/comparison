var Match,
  ...
  render_operations,
  wrap;
var is_end_of_tag = function (char) {
  return char === ">";
};
var is_start_of_tag = function (char) {
  return char === "<";
};
var is_whitespace = function (char) {
  return /^\s+$/.test(char);
};
var is_tag = function (token) {
  return /^\s*<[^>]+>\s*$/.test(token);
};
var isnt_tag = function (token) {
  return !is_tag(token);
};
Match = class Match {
...
op_map.replace = function (op, before_tokens, after_tokens) {
  return op_map.insert(op, before_tokens, after_tokens) + op_map.delete(op, before_tokens, after_tokens);
};
